...
| G-OPENAI-REALTIME-CANCEL | G0 | OpenAI API | In-progress response cancellation; cancelled response state while the Realtime session remains | https://platform.openai.com/docs/api-reference/realtime-client-events |
...
| G-GITHUB-AGENT-SESSION-MANAGEMENT | G0 | GitHub Docs | Monitor, steer and stop Agent sessions; Stop session ends the Actions run while preserving pushed commits | https://docs.github.com/en/copilot/how-tos/copilot-on-github/use-copilot-agents/manage-and-track-agents |
