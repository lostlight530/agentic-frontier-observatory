...
| G-MCP-TASKS-EXTENSION | G0 | Model Context Protocol Tasks Extension | Durable task IDs, task state machine, polling/update/cancel lifecycle; current extension page is Draft | https://tasks.extensions.modelcontextprotocol.io/specification/draft/tasks |
...
| G-ITU-F74893 | G0 | ITU-T SG21 | F.748.93 Framework and Requirements for AI Agent Interoperability; Consented 2026-07-17; **Approved 2026-08-29 under AAP**; approval observed by repository 2026-09-01 | https://www.itu.int/ITU-T/workprog/wp_item.aspx?isn=23620 |
...
| G-NIST-IDENTITY | G1 | NIST NCCoE | Software and AI Agent Identity and Authorization; current site status `Reviewing Comments` | https://www.nccoe.nist.gov/projects/software-and-ai-agent-identity-and-authorization |
...
- F.748.93 is **Approved on 2026-08-29 under AAP**. Approval is standards-lifecycle evidence, not proof of implementation, conformance or deployed interoperability.
