...
- DOI resolver: `https://doi.org/10.5281/zenodo.22791334`
- Code repository: `https://github.com/lostlight530/agentic-frontier-observatory`
...
A future archived release should preserve this record as point-in-time publication history and use its own confirmed release metadata. DOI presence, citation metadata, or archival availability does not by itself establish source truth, hypothesis support, current-state correctness, scientific validity, or reproduction.
