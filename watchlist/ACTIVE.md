...
| G-W14 | Can revocation propagate across delegated subagents and external tools? | OPEN | Lifecycle evidence |
...
| G-W18 | Can key rotation and revocation reach origins quickly enough for incident response? | OPEN | Operational key lifecycle evidence |
| G-W19 | Does draft → publish become a stable execution boundary for shared Agents? | **STRENGTHENED / open** | Versioning, rollback and incident evidence |
...
| G-W21 | Can write approval, action constraints and data-return governance be composed without blind spots? | OPEN | Product controls, security guidance and incidents |
...
| G-W32 | Can one correlation ID span session, MCP/A2A calls, commit, PR, review and audit events? | OPEN | Trace-context mappings and implementations |
